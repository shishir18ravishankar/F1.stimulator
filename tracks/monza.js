...
const MZA_CTRL=[
  [78,695,20],[85,625,20],[91,555,20], // S/F main straight
  ...
  [190,812,19],[183,885,19],[175,958,19], // back straight
  [167,1030,19],
...
const TRACKS={
  mza:{id:'mza',tag:'MZA',name:'MONZA',halfW:6.0,lap:5793,ctrl:MZA_CTRL,
    ...
    pMod:{CdA:1.30,ClA:2.55,aeroDrag:0.86,mu:1.56}, // low drag/downforce, a bit less grip on the brakes
