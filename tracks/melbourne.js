...
// The lake sits inside the loop; active aero on the straights.
// Key corners: Jones (T1), Brabham (T2), the Lakeside chicane (T9-T10).
// Elevation: flat lakeside parkland (~2.5 m range). Active aero: automatic Straight/Corner Mode.
...
const MEL_CTRL=[
  ...
  [204,608,2.7],[248,644,2.5],[306,676,2.3], // run along Albert Road (straight)
  ...
  [578,388,2.4],[520,348,2.4],[462,308,2.4], // Lakeside Drive along the water (straight)
  [420,278,2.4],[396,256,2.4],
  [382,236,2.4],[378,218,2.4],               // T9 (R, fast, sixth-gear)
  [368,202,2.4],[352,196,2.4],               // T10 (L) the Lakeside chicane
  [302,200,2.5],[260,208,2.6],               // run to T11 (straight)
