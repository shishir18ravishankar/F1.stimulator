...
// T9-T10 double-left and climbs back through the long T11. Active aero opens
// the wings on the main straight and the T3-T4 and T10-T11 runs.
// Key corners: T1 (heavy stop from 320 km/h), the off-camber T9-T10, long T11.
// Elevation: gentle desert plateau (~8 m). Active aero: automatic Straight/Corner Mode.
// Scenery: floodlit desert - palm oasis, big stands, the Sakhir Tower.
const BAH_CTRL=[
  [240,560,4],[240,470,4],[240,380,4],       // S/F: the 1.09 km main straight
  ...
  [328,240,5.6],[332,190,6.2],               // run to T4 (straight)
  ...
  [620,342,1.4],[680,354,1.7],[740,366,2.0], // run to T11 (straight)
